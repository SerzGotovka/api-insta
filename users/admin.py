...
class CustomUserAdmin(UserAdmin):
    ...
    model = CustomUser
    list_display = ("username", "full_name", "email", "photo", "display_follows", "display_following",
    ...
    fieldsets = (
        (None, {"fields": ("username", "full_name", "email", "photo", "follows", 'following', "bio",
    ...
    add_fieldsets = (
        (None, {
            "classes": ("wide",),
            "fields": (
                "username", "full_name", "email", "photo", "bio", "follows", 'following',
